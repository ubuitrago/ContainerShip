...
RAG_TEMPLATE = """
You are a meticulous Docker expert. Answer the question with the best of your knowledge, using the provided context as a reference.   
...
Question: {question}
Answer with an explanation appropriate for a DevOps engineer:
"""
